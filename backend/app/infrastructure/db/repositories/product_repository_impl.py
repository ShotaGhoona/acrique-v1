...
class ProductRepositoryImpl(IProductRepository):
    ...
    def update(self, product: Product) -> Product:
        ...
        product_model.master_id = product.master_id
        product_model.production_type = product.production_type
        product_model.upload_requirements = product.upload_requirements
    ...
    def _to_entity(self, model: ProductModel, include_relations: bool = True) -> Product:
        ...
        return Product(
            ...
            production_type=model.production_type or 'standard',
            upload_requirements=model.upload_requirements,
