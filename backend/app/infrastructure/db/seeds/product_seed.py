...
PRODUCT_IMAGES = [
    ...
    {
        'product_id': 'qr-cube',
        's3_url': '/images/products/qr-cube-1.jpg',
        'alt': 'QRコードキューブ メイン',
        'is_main': True,
        'sort_order': 1,
    },
    {
        'product_id': 'qr-cube',
        's3_url': '/images/products/qr-cube-2.jpg',
        'alt': 'QRコードキューブ 使用例',
        'is_main': False,
        'sort_order': 2,
    },
    {
        'product_id': 'qr-cube',
        's3_url': '/images/products/qr-cube-3.jpg',
        'alt': 'QRコードキューブ サイズ比較',
        'is_main': False,
        'sort_order': 3,
    },
    # Logo Cutout
    {
        ...
        's3_url': '/images/products/logo-cutout-1.jpg',
        'alt': 'ロゴカットアウト メイン',
        'is_main': True,
        'sort_order': 1,
    },
    {
        'product_id': 'logo-cutout',
        's3_url': '/images/products/logo-cutout-2.jpg',
        'alt': 'ロゴカットアウト 使用例',
        'is_main': False,
        'sort_order': 2,
    },
    # Price Tag
    {
        ...
        's3_url': '/images/products/price-tag-1.jpg',
        'alt': 'プライスタグ メイン',
        'is_main': True,
        'sort_order': 1,
    },
    # Menu Stand
    {
        ...
        's3_url': '/images/products/menu-stand-1.jpg',
        'alt': 'メニュースタンド メイン',
        'is_main': True,
        'sort_order': 1,
    },
    {
        'product_id': 'menu-stand',
        's3_url': '/images/products/menu-stand-2.jpg',
        'alt': 'メニュースタンド 使用例',
        'is_main': False,
        'sort_order': 2,
    },
    # Display Riser
    {
        ...
        's3_url': '/images/products/display-riser-1.jpg',
        'alt': 'ディスプレイライザー メイン',
        'is_main': True,
        'sort_order': 1,
    },
    # Sign Holder
    {
        ...
        's3_url': '/images/products/sign-holder-1.jpg',
        'alt': 'サインホルダー メイン',
        'is_main': True,
        'sort_order': 1,
    },
    # Wall Sign
    {
        ...
        's3_url': '/images/products/wall-sign-1.jpg',
        'alt': 'ウォールサイン メイン',
        'is_main': True,
        'sort_order': 1,
    },
    {
        'product_id': 'wall-sign',
        's3_url': '/images/products/wall-sign-2.jpg',
        'alt': 'ウォールサイン 設置例',
        'is_main': False,
        'sort_order': 2,
    },
    # Tombstones
    {
        ...
        's3_url': '/images/products/tombstones-1.jpg',
        'alt': '成約記念モニュメント メイン',
        'is_main': True,
        'sort_order': 1,
    },
    {
        'product_id': 'tombstones',
        's3_url': '/images/products/tombstones-2.jpg',
    ...
    # Name Plate
    {
        ...
        's3_url': '/images/products/name-plate-1.jpg',
        'alt': '役員用ネームプレート メイン',
        'is_main': True,
        'sort_order': 1,
    },
    ...
    {
        'product_id': 'award',
        's3_url': '/images/products/award-1.jpg',
        'alt': 'アワードトロフィー メイン',
        'is_main': True,
        'sort_order': 1,
    },
    {
        'product_id': 'award',
        's3_url': '/images/products/award-2.jpg',
    ...
    # Door Sign
    {
        ...
        's3_url': '/images/products/door-sign-1.jpg',
        'alt': 'ドアサイン メイン',
        'is_main': True,
        'sort_order': 1,
    },
    # Reception
    {
        ...
        's3_url': '/images/products/reception-1.jpg',
        'alt': 'レセプションサイン メイン',
        'is_main': True,
        'sort_order': 1,
    },
    # Card Display
    {
        ...
        's3_url': '/images/products/card-display-1.jpg',
        'alt': 'トレカディスプレイ メイン',
        'is_main': True,
        'sort_order': 1,
    },
    {
        'product_id': 'card-display',
        's3_url': '/images/products/card-display-2.jpg',
        'alt': 'トレカディスプレイ 使用例',
        'is_main': False,
        'sort_order': 2,
    },
    # Wedding Board
    {
        ...
        's3_url': '/images/products/wedding-board-1.jpg',
        'alt': 'ウェディングボード メイン',
        'is_main': True,
        'sort_order': 1,
    },
    {
        'product_id': 'wedding-board',
        's3_url': '/images/products/wedding-board-2.jpg',
        'alt': 'ウェディングボード デザイン例',
        'is_main': False,
        'sort_order': 2,
    },
    # Baby Print
    {
        ...
        's3_url': '/images/products/baby-print-1.jpg',
        'alt': '手形足形アート メイン',
        'is_main': True,
        'sort_order': 1,
    },
    # Photo Frame
    {
        ...
        's3_url': '/images/products/photo-frame-1.jpg',
        'alt': 'アクリルフォトフレーム メイン',
        'is_main': True,
        'sort_order': 1,
    },
    # Acrylic Stand
    {
        ...
        's3_url': '/images/products/acrylic-stand-1.jpg',
        'alt': 'アクリルスタンド メイン',
        'is_main': True,
        'sort_order': 1,
    },
    {
        'product_id': 'acrylic-stand',
        's3_url': '/images/products/acrylic-stand-2.jpg',
        'alt': 'アクリルスタンド サイズ展開',
        'is_main': False,
        'sort_order': 2,
    },
    # Key Block
    {
        ...
        's3_url': '/images/products/key-block-1.jpg',
        'alt': 'キーブロック メイン',
        'is_main': True,
        'sort_order': 1,
    },
...
PRODUCT_OPTION_VALUES = [
    ...
    # Card Display - カードサイズ
    {
        'option_key': 'card-display_カードサイズ',
    ...
    {
        'option_key': 'card-display_フレームデザイン',
        'label': 'クラシック',
        'price_diff': 0,
        'description': '上品な装飾',
        'sort_order': 1,
...
PRODUCT_FEATURES = [
    ...
    # Wall Sign
    {
        'product_id': 'wall-sign',
        'title': '浮遊感のあるデザイン',
        'description': '壁から浮かせることで影が生まれ、立体感と奥行きを演出。来訪者に印象的な第一印象を。',
        'sort_order': 1,
    },
    {
        'product_id': 'wall-sign',
        'title': '壁素材を活かす透明感',
        'description': 'コンクリート、木、タイルなど、壁の素材感を活かしながらブランドを主張できます。',
        'sort_order': 2,
    },
    {
        'product_id': 'wall-sign',
        'title': '選べる仕上げ',
        'description': 'UV印刷、レーザー彫刻、カッティングから、ブランドイメージに合った加工方法をお選びいただけます。',
        'sort_order': 3,
    },
    {
        'product_id': 'wall-sign',
        'title': '設置も安心',
        'description': '化粧ビス一式と詳細な取付説明書が付属。施工業者様への指示もスムーズです。',
        'sort_order': 4,
    },
    # Card Display
    {
        'product_id': 'card-display',
        'title': 'UVカット99%',
        'description': '紫外線を99%カットし、大切なカードを日焼けから守ります。窓際に飾っても安心。',
        'sort_order': 1,
    },
    {
        'product_id': 'card-display',
        'title': '3層構造で完全保護',
        'description': 'カードを3枚のアクリルで挟み込み、ホコリや傷から完全に保護します。',
        'sort_order': 2,
    },
    {
        'product_id': 'card-display',
        'title': '美しい装飾彫刻',
        'description': 'カード枠にレーザー彫刻で繊細な装飾を施し、高級感を演出します。',
        'sort_order': 3,
    },
    {
        'product_id': 'card-display',
        'title': 'スタンド付属',
        'description': '縦置き・横置き両対応のスタンドが付属。デスクや棚に美しくディスプレイできます。',
        'sort_order': 4,
    },
]
...
PRODUCT_FAQS = [
    # QR Cube
    {
        ...
        'answer': 'QRコードの画像データ（PNG/JPG）をお送りいただくか、リンク先URLをお知らせください。当方でQRコードを生成することも可能です。',
        'sort_order': 1,
    },
    {
        'product_id': 'qr-cube',
        'question': '複数のQRコードを1つのキューブに入れられますか？',
        'answer': '1面につき1つのQRコードとなります。複数面への印刷は別途ご相談ください。',
        'sort_order': 2,
    },
    {
        'product_id': 'qr-cube',
        'question': '屋外でも使用できますか？',
        'answer': '基本的に屋内使用を想定しています。直射日光や雨風にさらされる環境では、劣化が早まる可能性があります。',
        'sort_order': 3,
    },
    {
        'product_id': 'qr-cube',
        'question': '追加注文は可能ですか？',
        'answer': 'はい、同じデザインでの追加注文を承っております。データは1年間保管しておりますので、お気軽にご連絡ください。',
        'sort_order': 4,
    },
    # Wall Sign
    {
        ...
        'answer': '申し訳ございませんが、取り付け工事は承っておりません。お近くの施工業者様へご依頼ください。詳細な取付説明書をお付けしておりますので、スムーズに設置いただけます。',
        'sort_order': 1,
    },
    {
        'product_id': 'wall-sign',
        'question': 'ロゴデータはどのような形式で入稿すればよいですか？',
        'answer': 'AI（Illustrator）、EPS、PDF、SVGなどのベクターデータが最適です。JPG/PNGの場合は、解像度300dpi以上の高解像度データをご用意ください。',
        'sort_order': 2,
    },
    {
        'product_id': 'wall-sign',
        'question': '屋外に設置できますか？',
        'answer': '屋外対応オプション（+¥10,000〜）をご用意しております。UV耐性加工と防水処理を施します。ただし、直射日光が当たる場所での長期使用は推奨しておりません。',
        'sort_order': 3,
    },
    {
        'product_id': 'wall-sign',
        'question': '複数枚の注文で割引はありますか？',
        'answer': 'はい、3枚以上のご注文で10%OFF、10枚以上で15%OFFとなります。複数拠点への設置などでご活用ください。',
        'sort_order': 4,
    },
    # Card Display
    {
        ...
        'answer': 'インナースリーブ装着状態での収納を想定しています。厚手のスリーブやマグネットホルダーに入れた状態では入りませんのでご注意ください。',
        'sort_order': 1,
    },
    {
        'product_id': 'card-display',
        'question': 'PSA鑑定済みカードは入りますか？',
        'answer': 'PSAケースサイズ対応のディスプレイも別途ご用意しております。お問い合わせください。',
        'sort_order': 2,
    },
    {
        'product_id': 'card-display',
        'question': '複数枚セットでの割引はありますか？',
        'answer': '3個以上のご注文で10%OFF、5個以上で15%OFF、10個以上で20%OFFとなります。コレクション展示にご活用ください。',
        'sort_order': 3,
    },
    {
        'product_id': 'card-display',
        'question': 'カードの出し入れは簡単ですか？',
        'answer': '3層構造の中間層を取り外してカードを交換できます。頻繁な入れ替えにも対応しています。',
        'sort_order': 4,
    },
]
