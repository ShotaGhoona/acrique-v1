...
from app.application.schemas.admin.admin_upload_schemas import GetAdminUploadsInputDTO
from app.application.use_cases.admin.admin_upload_usecase import AdminUploadUsecase
from app.di.admin.admin_upload import get_admin_upload_usecase
from app.infrastructure.security.admin_security import (
    AdminAuth,
    get_current_admin_from_cookie,
)
from app.presentation.schemas.admin.admin_upload_schemas import (
    AdminUploadResponse,
