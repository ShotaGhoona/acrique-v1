...
import { adminDashboardApi } from '@/entities/admin-domain/admin-dashboard/api/admin-dashboard-api';
import type { GetStatsRequest } from '@/entities/admin-domain/admin-dashboard/model/types';
