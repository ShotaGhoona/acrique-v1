              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setSiteSettings({ ...siteSettings, phoneNumber: e.target.value })
                    }
                  />
                </div>
                <div className="space-y-2">
        ...
        <TabsContent value="notifications">
          <Card>
            <CardHeader>
              ...
              <CardDescription>管理者への通知設定を管理します。</CardDescription>
            </CardHeader>
        ...
        <TabsContent value="email">
          <Card>
            <CardHeader>
              ...
              <CardDescription>メール送信に関する設定を管理します。</CardDescription>
            </CardHeader>
            <CardContent className="py-8 text-center text-muted-foreground">
              メール設定（未実装）
            </CardContent>
        ...
        <TabsContent value="security">
          <Card>
            <CardHeader>
              ...
              <CardDescription>セキュリティに関する設定を管理します。</CardDescription>
            </CardHeader>
            <CardContent className="py-8 text-center text-muted-foreground">
              セキュリティ設定（未実装）
            </CardContent>
        ...
        <TabsContent value="appearance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>サイトの外観に関する設定を管理します。</CardDescription>
            </CardHeader>
            <CardContent className="py-8 text-center text-muted-foreground">
              外観設定（未実装）
            </CardContent>
