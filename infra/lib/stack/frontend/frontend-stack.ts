...
export interface FrontendStackProps extends cdk.StackProps {
   ...
   * 別途us-east-1リージョンでWAFスタックを作成し、そのARNを指定してください
   *
   * 例: arn:aws:wafv2:us-east-1:123456789012:global/webacl/my-webacl/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
   */
  webAclId?: string;
}
  ...
  constructor(
    ...
    const frontendResource = new FrontendResource(this, 'FrontendResource', {
      ...
      comment: `${config.envName} CDK Template Frontend`,
        spaMode: true,
      removalPolicy: config.removalPolicy,
        // WAF WebACL ARN（us-east-1で作成されたWAFのARN）
